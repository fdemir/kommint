export const componentSet = [
  ...
  },
  {
    ...
    description: "A mockup of the iPhone 15 Pro in a landscape orientation.",
    docs: {
      import: {
        code: 'import Iphone15ProMockup from "@/components/ui/iphone-15-pro-mockup";',
      },
      use: [
        {
          code: "<Iphone15ProMockup />",
        },
      ],
      examples: [
        {
          code: 'import Iphone15ProMockup from "@/components/ui/iphone-15-pro-mockup"; "\r\n\r\nexport default function Iphone15ProMockupDemo() {\r\n  return <Iphone15ProMockup />\r\n}',
        },
      ],
    },
  },
  {
    name: "Globe",
    description:
      "A globe component. Can be used on hero sections etc. DONT USE IT AS A ICON",
    docs: {
      import: {
        code: 'import Globe from "@/components/ui/globe"; "',
      },
      use: [
        {
          code: "<Globe />",
  ...
  {
    name: "Particles",
    description: "A dynamic particle animation component.",
    docs: {
      import: {
